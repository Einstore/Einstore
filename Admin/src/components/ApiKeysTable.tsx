  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-700 dark:bg-slate-800">
      <div className="-mx-5 border-b border-slate-200 pb-3 dark:border-slate-700">
        <div className="grid grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)_minmax(0,1.2fr)_minmax(0,1.2fr)_minmax(0,0.8fr)] gap-4 px-5 text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">
          <span>{t("apiKeys.header.name", "Name")}</span>
          <span>{t("apiKeys.header.type", "Type")}</span>
      ...
      <div className="-mx-5">
        {apiKeys.map((key) => {
          ...
          const typeLabel =
            key.type === "updates"
              ? t("apiKeys.type.updates", "Updates")
              : t("apiKeys.type.upload", "Upload");
          return (
            <div className="relative">
              <div
                ...
                className={`group grid grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)_minmax(0,1.2fr)_minmax(0,1.2fr)_minmax(0,0.8fr)] gap-4 border-b border-slate-200 px-5 py-4 text-sm last:border-b-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/40 dark:border-slate-700 ${
                  isSelected
              ...
              >
                ...
                <div className="text-slate-500 dark:text-slate-400">{typeLabel}</div>

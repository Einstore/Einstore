...
extension TestableProperty where TestableType: Application {
    ...
    public static func new(config: Config = Config.default(), env: Environment? = nil, services: Services = Services.default(), _ configClosure: AppConfigClosure? = nil, _ routerClosure: AppRouterClosure) throws -> Application {
        var config = config
    ...
    public func response(to request: HTTPRequest) throws -> Response {

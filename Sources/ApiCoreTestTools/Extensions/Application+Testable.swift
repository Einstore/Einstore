...
extension TestableProperty where TestableType: Application {
    ...
    public static func newApiCoreTestApp(_ configClosure: AppConfigClosure? = nil, _ routerClosure: AppRouterClosure? = nil) throws -> Application {
        let app = try new({ (config, env, services) in
